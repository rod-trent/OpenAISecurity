The ChatGPT_Azure_Sentinel_analytic_rule.json detection depends on a Watchlist called <i>ChatGPT_Trusted_Users</i> with the alias <i>ChatGPTPeople</i>.<Br><br>
